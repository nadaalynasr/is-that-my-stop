...
export const NETWORK_GRAPH: Record<string, string[]> = {
  ...
  'Five Points': ['Garnett', 'Peachtree Center', 'GWCC/CNN Center', 'Georgia State'], // Transfer Point
  ...
  'Vine City': ['Ashby', 'GWCC/CNN Center'],
  'GWCC/CNN Center': ['Vine City', 'Five Points'],

  // Blue/Green East
  'Georgia State': ['Five Points', 'King Memorial'],
  'King Memorial': ['Georgia State', 'Inman Park-Reynoldstown'],
  'Inman Park-Reynoldstown': ['King Memorial', 'Edgewood-Candler Park'],
  'Edgewood-Candler Park': ['Inman Park-Reynoldstown', 'East Lake'],
